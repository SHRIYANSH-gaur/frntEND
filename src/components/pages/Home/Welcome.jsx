      ...
      <div id="director-message" className="containerw mx-auto my-10">
        <div className="flexw flex-colw space-y-6 rounded-lg bg-light-purple overflow-hidden shadow-md md:flex-row md:space-y-0 md:space-x-6">
          <div className="basis-4/12">
            <img
              src="https://i.postimg.cc/bwYT06wH/360-C2536-C9-B1-4-FAA-B4-E8-1-B3-E1184-E490.jpg"
          ...
          >
            ...
            <p className="mess">
              ...
              intelligence, Theoretical computer science and many more. Dr.
              Sisodia has contributed to more than 100 refereed articles,
